...
def instructions():
    ...
    print('''
Bit Calculator Instructions.
To calculate integers type "integer" or "int"
To calculate images type "image", "picture", "img" or "p" 
To calculate text type "text", "txt" or "t" 
To end the program type "xxx"
    ''')
